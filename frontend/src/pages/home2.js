        ...
        <div>
            ...
            <div className='flex justify-center min-h-screen'>
                <div className='container mx-auto'>
                    ...
                    <form onSubmit={handleSearchSubmit} className="mt-5 flex items-center gap-4 flex-col md:flex-row">
                        <div className="relative flex-grow">
                            ...
                            <input
                                ...
                                className="border border-black rounded-3xl p-2 pl-10 ml-40 mt-2 bg-transparent w-full"
